...
import { GripVertical, Sparkles, Trash2, CheckCircle2 } from "lucide-react";
...
function TaskItem({
    ...
    // reset helper (removes duplication)
    const resetForm = () => {
    ...
    // PRIORITY STYLE MAPS
    // =====================
    const priority = editedPriority || task.priority || "medium";

    const priorityMap = {
        high: "text-violet-200 bg-violet-400/10 border-violet-400/20",
        medium: "text-cyan-200 bg-cyan-400/10 border-cyan-400/20",
                    ...
                    <div className="flex-1 min-w-0 space-y-3">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {isEditing ? (
                                ...
                                `}>
                                    <span className={`w-2 h-2 rounded-full ${dotMap[priority]}`} />
                                    {priority}
                                </div>
                            )}
